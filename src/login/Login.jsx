...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row items-center justify-center bg-gray-50">
      {/* Image Section */}
      <div className="hidden md:flex w-1/2 pl-12 pr-4 justify-start items-center">
       <img
         src="photos/shoppinggirl.png"
         alt="Shopping girl"
         className="max-w-sm h-auto object-contain animate__animated animate__fadeInLeft"
         loading="lazy"
       />
      </div>
